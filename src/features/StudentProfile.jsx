...
export function StudentProfile({ profile, onSave, authUser, onUsernameChange }) {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      ...
      {tab === "info" && (
        <div className="card">
          <Field label="Username" hint="This appears on the leaderboard and your profile">
            <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  whiteSpace: "nowrap",
                  opacity: (usernameSaving || usernameDraft.trim() === authUser?.username) ? 0.5 : 1,
                }}
              >

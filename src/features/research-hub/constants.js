...
export const sharedStyles = {
  ...
  subTabRow: {
    display: "flex", gap: spacing.lg, borderBottom: `0.5px solid ${colors.border}`,
    marginBottom: spacing.lg, width: "100%",
  },
  subTab: {
    padding: "8px 4px", background: "none", border: "none",
    borderBottom: "2px solid transparent", fontSize: fontSize.base,
    fontWeight: fontWeight.semibold, color: colors.textDim, cursor: "pointer",
    whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: spacing.sm,
    marginBottom: "-0.5px", transition: "color 0.15s, border-color 0.15s",
  },
  subTabActive: {
    padding: "8px 4px", background: "none", border: "none",
    borderBottom: `2px solid ${gold}`, fontSize: fontSize.base,
    fontWeight: fontWeight.bold, color: goldText, cursor: "pointer",
    whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: spacing.sm,
    marginBottom: "-0.5px", transition: "color 0.15s, border-color 0.15s",
  },
  searchWrap: {

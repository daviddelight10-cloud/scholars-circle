...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We support 11 programs: Medicine & Surgery (MBBS), Medical Laboratory Science, Nursing Science, Radiography, Dentistry, Physiotherapy, Anatomy, Physiology, Biochemistry, Microbiology, and postgraduate Dermatology & Paediatrics.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Absolutely! Clinicians and professors can create and manage question banks, assign clinical case studies, track student progress, and use campus communication tools. We offer special features and pricing for medical schools and teaching hospitals.'
    },
    {
    ...
    {
      question: 'Can I use Scholar\'s Circle on clinical rotations?',
      answer: 'Yes! We offer offline access to downloaded questions, flashcards, and drug reference. Your progress syncs automatically when you reconnect — perfect for wards with poor connectivity.'
    },
    {
      question: 'How do I get started?',
      answer: 'Simply click "Start Free Trial" to create your account. Select your medical program, university, and current courses. Once registered, you can immediately start practicing with our medical question bank and clinical cases.'
    },
    {
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '64px' }}>
          ...
          <p style={{
            ...
            Find answers to common questions about Scholar's Circle for medical students.
          </p>
        </div>

      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '64px' }}>
          <h2 style={{
            ...
            Why Medical Schools Choose Scholar's Circle
          </h2>
          <p style={{
            color: '#94a3b8',
            fontSize: '1.125rem',
            ...
            Empowering medical schools and teaching hospitals with comprehensive learning management tools 
            that enhance clinical education and streamline faculty workflows.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#94a3b8', fontSize: '14px' }}>
              Clinicians can create, manage, and share question banks across medical departments. 
              Build a centralized repository of exam materials for MBBS, MLS, Nursing, and more.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: '#94a3b8', fontSize: '14px' }}>
              Track student progress across clinical rotations, identify at-risk learners, and provide 
              targeted interventions with detailed performance analytics.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: '#94a3b8', fontSize: '14px' }}>
              Send announcements, share clinical guidelines, and keep students informed with 
              integrated campus communication tools for medical schools.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: '#94a3b8', fontSize: '14px' }}>
              Create and distribute clinical case assignments, track submissions, and provide feedback 
          ...
          <div style={{
            ...
            <p style={{ color: '#94a3b8', fontSize: '14px' }}>
              Leverage AI to generate clinical case scenarios, provide study assistance, and offer 
        ...
        <div style={{
          ...
          <p style={{
            ...
            Join the growing number of medical schools and teaching hospitals transforming education with Scholar's Circle. 

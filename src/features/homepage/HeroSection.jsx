      ...
      <div style={{
        ...
        <div style={{ animation: 'slideUp 0.8s ease both' }}>
          <h1 style={{
            ...
            Your Medical Education Companion with
            <span style={{
              display: 'block',
          ...
          <p style={{
            ...
            The all-in-one study platform built exclusively for medical & health-science students. 
            Clinical case simulations, OSCE prep, drug reference, spaced repetition flashcards, and more.
          </p>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <span>11 Medical Programs</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ fontSize: '24px' }}>💊</span>
              <span>Clinical Cases & OSCE Prep</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ fontSize: '24px' }}>⭐</span>

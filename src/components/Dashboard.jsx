...
function VoiceTutorWidget({ onOpenVoiceTutor }) {
  return (
    <div
      onClick={onOpenVoiceTutor}
      style={{
        background: `linear-gradient(135deg, rgba(79,124,255,0.12), ${T.inkCard})`,
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, flex: 1 }}>
        ...
        <p style={{
          ...
          Have a real-time voice conversation with an AI tutor grounded in your uploaded documents. Ask questions, get explanations, and quiz yourself — all by speaking naturally.
        </p>
      </div>
      <div style={{
        position: "relative",
  ...
  return (
    <div style={{ fontFamily: FONTS.body, color: T.text, maxWidth: 1180, margin: "0 auto", padding: "0 0 80px" }}>
      ...
      <div style={{ marginTop: 20 }}>
        <VoiceTutorWidget onOpenVoiceTutor={() => onOpenTab?.("voice-tutor")} />
      </div>
